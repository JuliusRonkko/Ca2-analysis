function [s, d, energ] = HippoEvent_FastBest(region,nn,period,sss,ddd)
...
%                         figure
        %
        [spkVetHelp, sh, dh, ener]= spkCalc_extractProva(trDif,i:i+length(trDif)-1,3,mu,sigma,(stdTh+addstd));
